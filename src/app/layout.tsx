...
export const metadata: Metadata = {
  title: "Aria · Travel and Expense Controller",
  description: "An AI employee that holds the T&E controller role: adjudicates every charge, investigates, codes, posts, and escalates only what exceeds its authority.",
};
